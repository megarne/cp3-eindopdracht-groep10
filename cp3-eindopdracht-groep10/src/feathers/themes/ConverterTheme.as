...
public class ConverterTheme extends DisplayListWatcher
{
    ...
    [Embed(source="/../assets/fonts/HomemadeApple.ttf",fontName="HomeMadeApple",mimeType="application/x-font",embedAsCFF="false")]
    protected static const HOME_MADE_APPLE:Class;
        ...
        public function ConverterTheme(container:DisplayObjectContainer = null, scaleToDPI:Boolean = true)
        {
            if(!container)
            {
        ...
        protected function initialize():void
        {
            ...
            const headerFont:String = "HomeMadeApple";
            ...
            const backgroundInsetSkinTexture:Texture = backgroundSkinTexture;
            const backgroundDownSkinTexture:Texture = backgroundSkinTexture;
